...
import { LayoutDashboard, ListTodo, Users, BookOpen, Plus, Settings, Shield, ShieldCheck, Package, Wallet, UserPlus, MessageSquareHeart, FileText, Gift, CalendarClock, FolderOpen, Feather } from 'lucide-react';
...
const navItems = [
  ...
  { id: 'expenses', label: '费用记账', icon: Wallet },
  { id: 'guests', label: '宾客登记', icon: UserPlus },
  { id: 'gifts', label: '随礼登记', icon: Gift },
  { id: 'ceremony', label: '告别仪式', icon: CalendarClock },
  { id: 'obituary', label: '讣告生成', icon: FileText },
  { id: 'eulogy', label: '悼词编辑', icon: Feather },
